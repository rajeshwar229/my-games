$(document).ready(function(){
		...
		$(".main,.helpPage,.game").hide();
                $(".play").click(function(){$(".main").fadeIn(300);$(".entrance").slideUp(200);$(".helpPage").slideUp(200);l=3;$(".lifes").text("Lifes x "+ l);});
                ...
                $(".retry").click(function(){$(".game").slideToggle(200);$(".main").slideToggle(300);$(".lifes").text("Lifes x "+ l);raj.css({"left":50 ,"top":300});});
...
"background":"rgb("+Math.round(Math.random()*255) +","+Math.round(Math.random()*255) +","+Math.round(Math.random()*255) +")"});} 
                function lifes(){if(flag==1){l--;flag=0;setPos();}$(".lifes").text("Lifes x "+ l);}
...
if(bw>=$(".main").width()){$(".main").hide();$(".game").show();$(".gameText").html("Congrats..U Won.!!").css("color","blue");}});
                ...
                raj.on("mouseleave",function(){lifes();flag=0;if(l==0){l=3;$(".main").hide();$(".game").show();$(".gameText").html("GAME OVER...!!");}});
